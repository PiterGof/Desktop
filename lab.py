...
my_module.hello_world('Egor')  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world('Egor'))  # Функция hello_world должна вызываться без указания модуля